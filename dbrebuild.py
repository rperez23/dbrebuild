...
def disclaimer():
    ...
    print ("")
    print ("    This script is provided for information purposes only")
    print ("    If issues are encountered please contact Autodesk Flame/Smoke Technical Support team")
    print ("    Troubleshooting of this script is not covered by Technical Support.")
    print ("    Technical Support can investigate issues related to your Autodesk software (with a valid support contract)")
    print ("    To contact Technical Support : https://manage.autodesk.com")
    print ("==========================================================================================")
